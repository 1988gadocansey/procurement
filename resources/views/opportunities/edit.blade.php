...
@section('content')
    ...
    <h3 class="heading_b uk-margin-bottom"> {{$tender->type}}</h3>

    <div class="md-card">
        <div class="md-card-content large-padding">

            <form  novalidate id="wizard_advanced_form" class="uk-form-stacked"   action="{{route("tender.update",$tender->id)}}" method="post" accept-charset="utf-8"  name="updateForm"  v-form>
                @csrf
                {!! method_field('put') !!}
                            ...
                            <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_referer">Type of tender :</label><input type="text" id="type" name="type" class="md-input" value="{{$tender->type}}"  required="required"     v-model="type"  v-form-ctrl><span class="md-input-bar"></span></div>
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_referer">Opportunity :</label><input type="text" id="opportunity" name="opportunity" value="{{$tender->opportunity}}" class="md-input"   required="required"     v-model="opportunity"  v-form-ctrl><span class="md-input-bar"></span></div>
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_skype">Year :</label><input type="number" id="year" name="year" v-form-ctrl  class="md-input"    v-model="year" value="{{$tender->year}}"  required    /><span class="md-input-bar"></span></div>
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_referer">Industry:</label><input type="text" id="industry" name="industry" class="md-input"   required="required" value="{{$tender->industry}}"      v-model="industry"  v-form-ctrl><span class="md-input-bar"></span></div>
                            ...
                            <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_referer">Expression of interest</label><textarea id="interest" name="interest" class="md-input"    rows="10" cols="50"   v-model="interest"  v-form-ctrl>{{$tender->expression_of_interest}}</textarea></div>
                                    </div>
                                </div>
